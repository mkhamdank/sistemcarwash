...
<html lang="">
	...
	<body>
		<div class="container">
			...
			<section>
				<a class="btn btn-primary" href="<?php echo site_url('mobil/create') ?>">Tambah Data Mobil</a>
						...
						<tbody>
							<?php foreach ($mobil as $key) { ?>
								<tr>
									...
									<td><a class="btn btn-success" href="<?php echo site_url('mobil/edit/'.$key->id_mobil) ?>">Edit</a>
										<a class="btn btn-danger" href="<?php echo site_url('mobil/delete/'.$key->id_mobil) ?>">Delete</a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
