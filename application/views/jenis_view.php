...
<html lang="">
	...
	<body>
		<div class="container">
			...
			<section>
				<a class="btn btn-primary" href="<?php echo site_url('jenis/create') ?>">Tambah Jenis Mobil</a>
				<legend>Data Jenis Mobil</legend>
						...
						<tbody>
							<?php foreach ($jenis as $key) { ?>
								<tr>
									...
									<td><a class="btn btn-success" href="<?php echo site_url('jenis/edit/'.$key->id_jenis) ?>">Edit</a>
										<a class="btn btn-danger" href="<?php echo site_url('jenis/delete/'.$key->id_jenis) ?>">Delete</a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
