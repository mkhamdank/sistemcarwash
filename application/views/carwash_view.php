			...
			<section>
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<a class="btn btn-primary" href="<?php echo site_url('carwash/create') ?>">Tambah Transaksi</a>
								...
								<tbody>
									<?php foreach ($transaksi as $key) { ?>
										<tr>
											...
											<td><a class="btn btn-warning" href="<?php echo site_url('carwash/detail/'.$key->id_transaksi) ?>">Detail</a>
											<a class="btn btn-success" href="<?php echo site_url('carwash/edit/'.$key->id_transaksi) ?>">Edit</a>
