...
<html lang="">
	...
	<body>
		<div class="container">
			...
			<section>
				<?php echo form_open('jenis/create'); ?>
				<?php echo validation_errors(); ?>
					<legend>Tambah Data Jenis Mobil</legend>
					<div class="form-group">
						<label for="">ID Jenis</label>
						<input type="text" class="form-control" name="id_jenis" id="" placeholder="ID Jenis" value="<?php foreach ($jenis as $key) {
						...
						<input type="text" class="form-control" name="jenis_mobil" id="" placeholder="Jenis Mobil">
